...
import { CreditCard, Smartphone, Building2, Truck, Shield, CheckCircle, MapPin } from "lucide-react";
                  ...
                  <div className="bg-card rounded-xl sm:rounded-2xl p-4 sm:p-6 border border-border">
                    ...
                    <div className="space-y-4">
                      ...
                      <div>
                        ...
                        <Input name="phone" type="tel" value={formData.phone} onChange={handleInputChange} placeholder="+91 98765 43210" className="h-11 sm:h-12" readOnly />
                      </div>
                      <div>
